...
/**
 * 根据名称或者别名持有beanDefinition。它承载了name和BeanDefinition的映射信息。可以为一个内部bean 注册为placeholder。
 *
 * <p>BeanDefinitionHolder也可以编写一个内部bean definition的注册，
 * 如果你不关注BeanNameAware等，完全可以使用RootBeanDefinition或者ChildBeanDefinition来替代。
 *
